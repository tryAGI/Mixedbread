...
namespace Mixedbread
{
    public partial class AdminClient
    {
        ...
        partial void PrepareReingestAllStoresArguments(
            ...
            global::System.Collections.Generic.IList<global::Mixedbread.VectorStoreFileStatus>? statuses,
            ref bool? billable);
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mixedbread.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mixedbread.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ReingestAllStores",
                                methodName: "ReingestAllStoresAsync",
                                pathTemplate: "$\"/v1/admin/stores/{organizationId}/{storeIdentifier}/reingest\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
