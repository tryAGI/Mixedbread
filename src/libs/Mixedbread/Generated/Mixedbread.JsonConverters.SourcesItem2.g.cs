...
{
    /// <inheritdoc />
    public class SourcesItem2JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Mixedbread.SourcesItem2>
    {
        /// <inheritdoc />
        public override global::Mixedbread.SourcesItem2 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Mixedbread.VectorStoreQAResultsSourceDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Mixedbread.VectorStoreQAResultsSourceDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Mixedbread.VectorStoreQAResultsSourceDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::Mixedbread.MxbaiOmniApiRoutesV1DeprecatedVectorStoresModelsScoredTextInputChunk? text = default;
            if (discriminator?.Type == global::Mixedbread.VectorStoreQAResultsSourceDiscriminatorType.Text)
            {
            ...
            if (discriminator?.Type == global::Mixedbread.VectorStoreQAResultsSourceDiscriminatorType.ImageUrl)
            {
            ...
            if (discriminator?.Type == global::Mixedbread.VectorStoreQAResultsSourceDiscriminatorType.AudioUrl)
            {
            ...
            if (discriminator?.Type == global::Mixedbread.VectorStoreQAResultsSourceDiscriminatorType.VideoUrl)
            {
            ...
            var __value = new global::Mixedbread.SourcesItem2(
                discriminator?.Type,
                text,
        ...
        public override void Write(
            ...
            global::Mixedbread.SourcesItem2 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
