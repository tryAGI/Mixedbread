            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Mixedbread.StoreQAResults.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Mixedbread.StoreQAResults.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
