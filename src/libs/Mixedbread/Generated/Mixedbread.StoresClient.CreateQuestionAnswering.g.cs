...
namespace Mixedbread
{
    public partial class StoresClient
    {
        ...
        {
            var __response = await CreateQuestionAnsweringAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mixedbread.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mixedbread.AutoSDKHttpResponse<global::Mixedbread.StoreQAResults>> CreateQuestionAnsweringAsResponseAsync(
                    ...
                    await global::Mixedbread.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Mixedbread.StoreQAResults.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Mixedbread.AutoSDKHttpResponse<global::Mixedbread.StoreQAResults>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Mixedbread.StoreQAResults.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
