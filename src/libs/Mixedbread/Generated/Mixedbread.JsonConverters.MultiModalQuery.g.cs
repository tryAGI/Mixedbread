...
{
    /// <inheritdoc />
    public class MultiModalQueryJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Mixedbread.MultiModalQuery>
    {
        /// <inheritdoc />
        public override global::Mixedbread.MultiModalQuery Read(
            ...
            if (__bestIndex >= 0)
            {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        multiModalQueryVariant2 = global::System.Text.Json.JsonSerializer.Deserialize<global::Mixedbread.MultiModalQueryVariant2>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
        ...
        public override void Write(
            ...
            global::Mixedbread.MultiModalQuery value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options)); 
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.MultiModalQueryVariant2, typeof(global::Mixedbread.MultiModalQueryVariant2), options);
            }
        }
    }
}